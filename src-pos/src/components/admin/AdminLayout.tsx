...
const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { id: 'orders', labelKey: 'receipts_sales', defaultLabel: 'Receipts & Sales', icon: Receipt },
  { id: 'suppliers', labelKey: 'suppliers_intake', defaultLabel: 'Suppliers & Intake', icon: Truck },
  { id: 'products', labelKey: 'products_stock', defaultLabel: 'Products & Stock', icon: Package },
  { id: 'shifts', labelKey: 'register_shifts_tab', defaultLabel: 'Register & Shifts', icon: CircleDollarSign },
  { id: 'cashiers', labelKey: 'cashiers_staff', defaultLabel: 'Cashiers & Staff', icon: UserCheck },
  { id: 'reports', labelKey: 'sales_reports_tab', defaultLabel: 'Sales Reports', icon: BarChart3 },
  { id: 'customers', labelKey: 'customers_tab', defaultLabel: 'Customers', icon: Users },
  { id: 'translations', labelKey: 'translations_tab', defaultLabel: 'Translations & i18n', icon: Languages },
  { id: 'migration', labelKey: 'migration_tab', defaultLabel: 'Data Migration', icon: UploadCloud },
  { id: 'updates', labelKey: 'updates', defaultLabel: 'Updates', icon: Sparkles },
  { id: 'settings', labelKey: 'pos_settings_tab', defaultLabel: 'POS Settings', icon: Settings },
];
...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen flex bg-slate-50 dark:bg-[#080d1a] text-slate-900 dark:text-slate-100 overflow-hidden font-sans select-none">
      {/* Left Sidebar */}
      <aside className="w-64 bg-white dark:bg-[#0f172a] border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between shrink-0 shadow-sm z-30 transition-colors">
        <div>
          {/* Admin Hub Header */}
