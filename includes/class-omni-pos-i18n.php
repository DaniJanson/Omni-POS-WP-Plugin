...
class Omni_POS_I18n {
	...
	public static function get_default_strings() {
		return array(
			...
			'receipts_sales'        => array( 'cat' => 'general', 'en' => 'Sales & Receipts' ),
			'suppliers_intake'      => array( 'cat' => 'general', 'en' => 'Suppliers' ),
			'products_stock'        => array( 'cat' => 'general', 'en' => 'Products' ),
			'register_shifts_tab'   => array( 'cat' => 'general', 'en' => 'Register & Shifts' ),
			'cashiers_staff'        => array( 'cat' => 'general', 'en' => 'Staff & Roles' ),
			'sales_reports_tab'     => array( 'cat' => 'general', 'en' => 'Reports & Analytics' ),
			'customers_tab'         => array( 'cat' => 'general', 'en' => 'Customers' ),
			'translations_tab'      => array( 'cat' => 'general', 'en' => 'Languages & i18n' ),
			'migration_tab'         => array( 'cat' => 'general', 'en' => 'Migration & Import' ),
			'pos_settings_tab'      => array( 'cat' => 'general', 'en' => 'Settings' ),
			'updates'               => array( 'cat' => 'general', 'en' => 'Updates' ),

			// Sub-labels (2-word subtitles for sidebar navigation)
			'tab_dashboard'         => array( 'cat' => 'navigation', 'en' => 'Dashboard' ),
			'tab_dashboard_sub'     => array( 'cat' => 'navigation', 'en' => 'Stats & Overview' ),
			'tab_orders'            => array( 'cat' => 'navigation', 'en' => 'Sales' ),
			'tab_orders_sub'        => array( 'cat' => 'navigation', 'en' => 'Receipts & History' ),
			'tab_suppliers'         => array( 'cat' => 'navigation', 'en' => 'Suppliers' ),
			'tab_suppliers_sub'     => array( 'cat' => 'navigation', 'en' => 'Intake & Orders' ),
			'tab_products'          => array( 'cat' => 'navigation', 'en' => 'Products' ),
			'tab_products_sub'      => array( 'cat' => 'navigation', 'en' => 'Stock & Catalog' ),
			'tab_shifts'            => array( 'cat' => 'navigation', 'en' => 'Register' ),
			'tab_shifts_sub'        => array( 'cat' => 'navigation', 'en' => 'Shifts & Cash' ),
			'tab_cashiers'          => array( 'cat' => 'navigation', 'en' => 'Staff' ),
			'tab_cashiers_sub'      => array( 'cat' => 'navigation', 'en' => 'Cashiers & Roles' ),
			'tab_reports'           => array( 'cat' => 'navigation', 'en' => 'Reports' ),
			'tab_reports_sub'       => array( 'cat' => 'navigation', 'en' => 'Analytics & Charts' ),
			'tab_customers'         => array( 'cat' => 'navigation', 'en' => 'Customers' ),
			'tab_customers_sub'     => array( 'cat' => 'navigation', 'en' => 'Directory & History' ),
			'tab_translations'      => array( 'cat' => 'navigation', 'en' => 'Languages' ),
			'tab_translations_sub' => array( 'cat' => 'navigation', 'en' => 'Translations & i18n' ),
			'tab_migration'         => array( 'cat' => 'navigation', 'en' => 'Migration' ),
			'tab_migration_sub'     => array( 'cat' => 'navigation', 'en' => 'Import & Export' ),
			'tab_updates'           => array( 'cat' => 'navigation', 'en' => 'Updates' ),
			'tab_updates_sub'       => array( 'cat' => 'navigation', 'en' => 'Versions & System' ),
			'tab_settings'          => array( 'cat' => 'navigation', 'en' => 'Settings' ),
			'tab_settings_sub'      => array( 'cat' => 'navigation', 'en' => 'Hardware & Setup' ),
			...
			// Chrome Extension & Hardware Settings
			'hardware_settings'     => array( 'cat' => 'general', 'en' => 'Hardware & Printers (Chrome Extension)' ),
			'hardware_tab'          => array( 'cat' => 'general', 'en' => 'Hardware & Printers' ),
			'extension_status'      => array( 'cat' => 'general', 'en' => 'Chrome Extension Status' ),
			'extension_active'      => array( 'cat' => 'general', 'en' => 'Extension Active & Connected' ),
			'extension_connecting'  => array( 'cat' => 'general', 'en' => 'Connecting to Extension...' ),
			'extension_offline'     => array( 'cat' => 'general', 'en' => 'Extension Offline' ),
			...
			'silent_print_desc'     => array( 'cat' => 'general', 'en' => 'Print receipts instantly via Chrome Extension without opening browser print dialog' ),
			...
			'migration_hub'         => array( 'cat' => 'general', 'en' => 'VitePOS Migration Engine' ),
			'migration_hub_btn'     => array( 'cat' => 'general', 'en' => '🔄 VitePOS ➔ Omni Data Migration' ),
	...
	public static function get_locale_presets() {
		return array(
			...
			'ka_GE' => array(
				...
				'dashboard'             => 'მთავარი',
				'receipts_sales'        => 'გაყიდვები',
				'suppliers_intake'      => 'მომწოდებლები',
				'products_stock'        => 'პროდუქცია',
				'register_shifts_tab'   => 'სალარო',
				'cashiers_staff'        => 'პერსონალი',
				'sales_reports_tab'     => 'ანალიტიკა',
				'customers_tab'         => 'კლიენტები',
				'translations_tab'      => 'ენები',
				'migration_tab'         => 'მიგრაცია',
				'pos_settings_tab'      => 'პარამეტრები',
				'updates'               => 'განახლება',

				// Sub-labels in Georgian
				'tab_dashboard'         => 'მთავარი',
				'tab_dashboard_sub'     => 'სტატისტიკა & მიმოხილვა',
				'tab_orders'            => 'გაყიდვები',
				'tab_orders_sub'        => 'ჩეკები & ისტორია',
				'tab_suppliers'         => 'მომწოდებლები',
				'tab_suppliers_sub'     => 'შესყიდვები & მიღება',
				'tab_products'          => 'პროდუქცია',
				'tab_products_sub'      => 'მარაგები & ფასები',
				'tab_shifts'            => 'სალარო',
				'tab_shifts_sub'        => 'ცვლები & თანხა',
				'tab_cashiers'          => 'პერსონალი',
				'tab_cashiers_sub'      => 'მოლარეები & როლები',
				'tab_reports'           => 'ანალიტიკა',
				'tab_reports_sub'       => 'გრაფიკები & რეპორტები',
				'tab_customers'         => 'კლიენტები',
				'tab_customers_sub'     => 'ბაზა & ისტორია',
				'tab_translations'      => 'ენები',
				'tab_translations_sub' => 'თარგმანი & ტექსტები',
				'tab_migration'         => 'მიგრაცია',
				'tab_migration_sub'     => 'იმპორტი & ექსპორტი',
				'tab_updates'           => 'განახლება',
				'tab_updates_sub'       => 'ვერსიები & სისტემა',
				'tab_settings'          => 'პარამეტრები',
				'tab_settings_sub'      => 'აპარატურა & კონფიგი',
				...
				// Chrome Extension & Hardware Georgian
				'hardware_settings'     => 'აპარატურა & პრინტერები (Chrome Extension)',
				'hardware_tab'          => 'აპარატურა & პრინტერები',
				'extension_status'      => 'Chrome Extension-ის სტატუსი',
				'extension_active'      => 'გაფართოება აქტიურია & დაკავშირებულია',
				'extension_connecting'  => 'გაფართოებასთან დაკავშირება...',
				'extension_offline'     => 'გაფართოება გათიშულია (ოფლაინ)',
				...
				'silent_print_desc'     => 'ჩეკის პირდაპირი ბეჭდვა Chrome Extension-ით ბრაუზერის Print ფანჯრის გარეშე',
				...
				'migration_hub'         => 'VitePOS-ის მიგრაციის ცენტრი',
				'migration_hub_btn'     => '🔄 VitePOS ➔ Omni მონაცემების მიგრაცია',
